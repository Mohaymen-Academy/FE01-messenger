...
export default function LoginLanding({ onClick, active }: LoginLandingProps) {
  return (
    <div
      ...
      className="relative right-[2%] top-0 z-10 w-[90%] overflow-hidden rounded-lg bg-white shadow transition-all duration-500 ease-out sm:right-[13%] sm:w-[80%] sm:max-w-md md:right-[23.5%] lg:right-[33.5%]"
    >
