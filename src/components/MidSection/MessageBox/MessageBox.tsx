    ...
    <div className="relative flex w-full max-w-xl items-center self-center overflow-hidden p-4 text-gray-600 focus-within:text-gray-400">
      <div className="w-full">
        <span className="absolute inset-y-0 left-0 flex items-center pl-6">
          <button
            type="submit"
            className="p-1 focus:shadow-none focus:outline-none"
          >
            <svg
        ...
        <input
          type="search"
          className="w-full appearance-none rounded-lg border border-transparent bg-white py-2 pl-10 text-sm placeholder:text-gray-800 focus:border-blue-500 focus:bg-white focus:text-gray-900 focus:shadow-blue-50 focus:outline-none"
          placeholder="Message..."
          autoComplete="off"
        />
      </div>
