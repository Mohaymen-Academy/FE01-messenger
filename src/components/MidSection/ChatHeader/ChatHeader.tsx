...
export default function ChatHeader({}: ChatHeaderProps) {
  return (
    <div className="z-20 flex w-full shrink-0 grow-0 border-b bg-white pr-3">
      ...
      <div className="relative my-3 hidden w-48 cursor-pointer border-l-2 border-blue-500 pl-2 lg:block">
      ...
      <button className="ml-2 flex self-center rounded-full p-2 text-gray-500 hover:bg-gray-300 hover:text-gray-600 focus:outline-none">
        <svg
      ...
      <button
        type="button"
        className="ml-2 hidden self-center rounded-full p-2 text-gray-500 hover:bg-gray-300 hover:text-gray-600 focus:outline-none md:block"
      >
        <svg
          className="h-6 w-6 fill-current text-gray-600"
          xmlns="http://www.w3.org/2000/svg"
