...
export default function SignUp({ active, onClick }: SignUpProps) {
  ...
  return (
    <div
      ...
      className="absolute right-[8%] top-0 mt-20 flex w-[80%] items-center justify-center rounded-lg bg-white shadow transition-all duration-700 ease-in sm:right-[15%] sm:max-w-md md:right-[25%] xl:right-[35.5%]"
    >
